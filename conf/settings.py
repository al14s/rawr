...
flist =         "url, ipv4, port, x-powered-by, options, returncode, hostnames, notes, Title, version, allow, cookies, meta, iframe, applet, object, script, embed, file_includes, SSL_Cert-KeyAlg, SSL_Tunnel-Ciphers, SSL_Tunnel-Weakest, SSL_Cert-DaysLeft, SSL_Cert-ValidityPeriod, SSL_Cert-MD5, SSL_Cert-SHA-1, SSL_Cert-notbefore, SSL_Cert-notafter, protocol, country, service, robots.txt, rpc_info, endURL, Date, Server, analytics_ID, owner, Content-MD5, Content-Type, Last-Modified, Trailer, Transfer-Encoding, Warning, X-XSS-Protection, X-Frame-Options, WWW-Authenticate, Proxy-Authenticate, Age, Robots, Keywords, Description, Author, Revised, form_start, passwordFields, emailAddresses, HTML5, info, Default Password Suggestions"
